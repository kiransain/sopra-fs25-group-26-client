...
| **@muluk99** | 07.04.2025      | [Added current rest-specifications.md](https://github.com/kiransain/sopra-fs25-group-26-client/commit/2d59f3edaa82953bdde4cc1fdf3e5d529889a631)                        |                                                            i rewrote the rest specifications with @ermin-mumic into what we hope will be the final form.                                                                                                                                                                                                                                                       | [As we have changed the endpoints from our Milestone 2 Rest specification we needed to document this change]                                                                                                                                                                                                                       |
|         **@muluk99**           | 07.04.2025| [[Link to Commit 2]   ](https://github.com/kiransain/sopra-fs25-group-26-server/commit/f0ed9a62f03c5d3b52761a35d030345fc776c72f)                                                                                                                                                         | - Refactors GameService.updateGame to correctly handle player joining - Implements PUT /games/{gameId}/location endpoint                                                                                                                                                                                                                                                         | [Why this contribution is relevant]                                                                                                                                                                                                                       |
